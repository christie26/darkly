...
The survey is expected to accept only predefined values but user bypassed using browser developer tools or by modifying the HTTP requestThis demostrates that the app relies on client-side
